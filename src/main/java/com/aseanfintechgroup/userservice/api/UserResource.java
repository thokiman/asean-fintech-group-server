package com.aseanfintechgroup.userservice.api;
...
public class UserResource {
    ...
    public ResponseEntity<?> addRoleToUser(
        ...
        // only build the response, no return
    ...
    public void refreshToken(
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                //verified the token with the same authentication token "secret" to authorization
